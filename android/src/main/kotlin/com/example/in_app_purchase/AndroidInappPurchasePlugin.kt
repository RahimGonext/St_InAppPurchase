...
import com.example.in_app_purchase.BillingError
import com.example.in_app_purchase.FlutterInAppPurchasePlugin
...
class AndroidInappPurchasePlugin internal constructor() : MethodCallHandler,
    ...
    private fun buyProduct(
        ...
        when (prorationMode) {
            ...
            else -> params.setReplaceSkusProrationMode(BillingFlowParams.ProrationMode.UNKNOWN_SUBSCRIPTION_UPGRADE_DOWNGRADE_POLICY)
        }
